...
<div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" onclick="$('#form').submit();" form="form-account" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
 ...
 <div class="panel-body">
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
     ...
     <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="page_nav_status" id="input-status" class="form-control">
                <?php if ($page_nav_status) { ?>
           ...
           <div class="form-group">
            ...
            <div class="col-sm-10">
             <select name="page_nav_position" class="form-control">
                 <?php if ($page_nav_position == 'left') { ?>
            <option value="left" selected="selected"><?php echo $text_left; ?></option>
            <?php } else { ?>
            <option value="left"><?php echo $text_left; ?></option>
            <?php } ?>
            <?php if ($page_nav_position == 'right') { ?>
